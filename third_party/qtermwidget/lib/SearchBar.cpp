...
SearchBar::SearchBar(QWidget *parent) : QWidget(parent)
{
    ...
    connect(
        widget.searchTextEdit, SIGNAL(textChanged(QString)), this, SIGNAL(searchCriteriaChanged()));
    ...
    connect(m_useRegularExpressionMenuEntry,
            SIGNAL(toggled(bool)),
            this,
    ...
    connect(m_highlightMatchesMenuEntry,
            SIGNAL(toggled(bool)),
            this,
            SIGNAL(highlightMatchesChanged(bool)));
    connect(
        m_highlightMatchesMenuEntry, SIGNAL(toggled(bool)), this, SIGNAL(searchCriteriaChanged()));
}
